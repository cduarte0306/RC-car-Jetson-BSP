...
# Enable UART serial console on ttyS0 (which is used by Jetson Nano)
SERIAL_CONSOLE ?= "115200 ttyS0"

# (Optional) Disable package management to reduce image size
EXTRA_IMAGE_FEATURES = "debug-tweaks"

# Setting the SDK host machine
SDKMACHINE = "x86_64"
...
# Force systemd globally
# Use systemd and enable required features
DISTRO_FEATURES:append = " systemd usrmerge"

# Make systemd the init manager
VIRTUAL-RUNTIME_init_manager = "systemd"

# Use systemd's udev
PREFERRED_PROVIDER_virtual/udev = "systemd-udev"

# Avoid backfilling sysvinit when using systemd
